...
echo("<div class=\"data\"><img src=\"plot.php?type=" . $type . $html_formatted_idlist . "&ymax=" . $ymax . "&ymin=" . $ymin . "&logscale=" . $logscale . "&xmax=" . $xmax . "&xmin="  . $xmin . $html_formatted_labellist . $html_formatted_offsetlist . "&x_transform=" . $x_transform . "\"></div>\n\n");

echo("<form name=\"mainform\" action=\"read_massspec.php\" method=\"get\">\n");
print("<div class=\"selectcontainer\"><b>Select measurement:</b><br>\n");
print("<select class=\"select\" name=\"chosen_times[]\" multiple size=\"8\" onChange=\"document.write('hello Wolrd');\">\n");
...
echo("<a href=\"plot_matplotlib.php?type=" . $type . $html_formatted_idlist . $html_formatted_labellist . "&x_transform=" . $x_transform . "\">Matplotlib</a></br>");
...
//document.mainform.elements[1].options.length=0;
</script>
<script src="get_components_.php?type=masstime&chosen_times[]=2010-12-14+14%3A45%3A06">
</script>
