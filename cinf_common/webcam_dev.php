...
$query = "SELECT unix_timestamp(time), value FROM dateplots_microreactorNG where type = 'T_sample' order by time desc limit 1";
$result  = mysql_query($query,$db);  
$row = mysql_fetch_array($result);
...
$query = "SELECT unix_timestamp(time), value FROM dateplots_microreactorNG where type = 'P_containment' order by time desc limit 1";
$result  = mysql_query($query,$db);  
$row = mysql_fetch_array($result);
