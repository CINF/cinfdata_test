...
<p class="left"><img src="plot.php?type=<?=$type?>&id=<?=$param["id"]?>&from=<?=$xscale["from"]?>&to=<?=$xscale["to"]?>&manualscale=<?=$manualscale?>&ymax=<?=$ymax?>&ymin=<?=$ymin?>"></p>
<form action="read_dateplot.php" method="get">
<input type="hidden" name="type" value="<?=$type?>">

<p><b>From:</b><input name="from" type="text" value="<?=$xscale["from"]?>" size="13" class="leftspace"><br>
<b>To:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input name="to" type="text" value="<?=$xscale["to"]?>" size="13" class="leftspace"></p>
...
<b>Min:</b>&nbsp;&nbsp;<input name="ymin" type="text" size="7" value="<?=$ymin?>"></p>
