...
$query = "SELECT unix_timestamp(time), pressure FROM pressure_stm312 where pressure > 0 and pressure < 3e-6 and time between \"2009-10-09 13:00:00\" and \"2009-10-12 12:00:00\" and id mod 5 = 0 order by id";
