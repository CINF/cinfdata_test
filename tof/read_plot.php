...
foreach($plotted_ids as $curr_id){
    ...
    $meta_informations[$curr_id]["stepsize"] = 0;#Removed due to performance problems
}
...
echo("<div class=\"flighttime\">");
    if($type == "tofspectrum"){
       ...
       $command = "/var/www/cinfdata/tof/flighttime/flighttime.py --liner=" . round($meta["specific_1"]) . " --pulse=" . round($meta["specific_0"]) . " --R1=" . round($meta["specific_8"]) . " --R2=" . round($meta["specific_9"]) . " 2>&1";
